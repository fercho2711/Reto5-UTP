...
public class VistaRequerimientosReto4 extends JFrame{
    ...
    public VistaRequerimientosReto4(){
        ...
        setBounds(450, 200, 700,630);
        contentPane = new JPanel();
        contentPane.setBorder(new EmptyBorder(3,3,3,3));
        setContentPane(contentPane);
        contentPane.setLayout(null);

        JLabel lbltitulo = new JLabel("Reto 5 - UTP - Misión TIC 2022");
        lbltitulo.setBounds(28, 6, 180, 16);
        contentPane.add(lbltitulo);

        JLabel lblautor = new JLabel("Jose Fernando Pacheco");
        lblautor.setBounds(28, 34, 208, 16);
        contentPane.add(lblautor);

        JScrollPane scrollPane = new JScrollPane();
        scrollPane.setBounds(28, 70, 637, 455);
        ...
        btnConsuta1.setBounds(28, 537, 127, 29);
        ...
        btnConsuta2.setBounds(157, 537, 127, 29);
        ...
        btnConsuta3.setBounds(286, 537, 127, 29);
        ...
        btnLimpiar.setBounds(548, 537, 117, 29);
